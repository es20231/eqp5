...
urlpatterns = [
    ...
    path('connections/', views.ConnectionAPIView.as_view(), name="connection_api_list"),
    path('connections/<int:id>/', views.ConnectionAPIView.as_view(), name="connection_api_detail"),
